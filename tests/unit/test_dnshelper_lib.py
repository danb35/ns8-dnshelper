...
class RealHelperTests(unittest.TestCase):
    ...
    def test_list_providers_matches_the_schema_the_library_expects(self):
        ...
        self.assertEqual(names, {'cloudflare', 'corenetworks', 'desec', 'digitalocean', 'gandi', 'godaddy', 'googleclouddns', 'hetzner', 'ionos', 'linode', 'namedotcom', 'porkbun', 'powerdns', 'rfc2136', 'route53', 'vultr'})
