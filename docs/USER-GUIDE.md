...
| deSEC | An API token, made at desec.io/tokens. It does not need the permissions to create or delete domains. If you limit it to some IP networks, include your NethServer's public address | [Manage tokens](https://desec.readthedocs.io/en/latest/auth/tokens.html) |
